...
QT_MOC_LITERAL(24, 313, 9), // "inputMask"
QT_MOC_LITERAL(25, 323, 4), // "text"
QT_MOC_LITERAL(26, 328, 9), // "maxLength"
QT_MOC_LITERAL(27, 338, 5), // "frame"
QT_MOC_LITERAL(28, 344, 8), // "echoMode"
QT_MOC_LITERAL(29, 353, 8), // "EchoMode"
QT_MOC_LITERAL(30, 362, 11), // "displayText"
QT_MOC_LITERAL(31, 374, 14), // "cursorPosition"
QT_MOC_LITERAL(32, 389, 9), // "alignment"
QT_MOC_LITERAL(33, 399, 13), // "Qt::Alignment"
QT_MOC_LITERAL(34, 413, 8), // "modified"
QT_MOC_LITERAL(35, 422, 15), // "hasSelectedText"
QT_MOC_LITERAL(36, 438, 12), // "selectedText"
QT_MOC_LITERAL(37, 451, 11), // "dragEnabled"
QT_MOC_LITERAL(38, 463, 8), // "readOnly"
QT_MOC_LITERAL(39, 472, 13), // "undoAvailable"
QT_MOC_LITERAL(40, 486, 13), // "redoAvailable"
QT_MOC_LITERAL(41, 500, 15), // "acceptableInput"
QT_MOC_LITERAL(42, 516, 15), // "placeholderText"
QT_MOC_LITERAL(43, 532, 15), // "cursorMoveStyle"
QT_MOC_LITERAL(44, 548, 19), // "Qt::CursorMoveStyle"
QT_MOC_LITERAL(45, 568, 18), // "clearButtonEnabled"
QT_MOC_LITERAL(46, 587, 14), // "ActionPosition"
QT_MOC_LITERAL(47, 602, 15), // "LeadingPosition"
QT_MOC_LITERAL(48, 618, 16), // "TrailingPosition"
QT_MOC_LITERAL(49, 635, 6), // "Normal"
QT_MOC_LITERAL(50, 642, 6), // "NoEcho"
QT_MOC_LITERAL(51, 649, 8), // "Password"
QT_MOC_LITERAL(52, 658, 18) // "PasswordEchoOnEdit"
    ...
    "_q_clearButtonClicked\0inputMask\0text\0"
    "maxLength\0frame\0echoMode\0EchoMode\0"
    "displayText\0cursorPosition\0alignment\0"
    "Qt::Alignment\0modified\0hasSelectedText\0"
    "selectedText\0dragEnabled\0readOnly\0"
    "undoAvailable\0redoAvailable\0acceptableInput\0"
    "placeholderText\0cursorMoveStyle\0"
    "Qt::CursorMoveStyle\0clearButtonEnabled\0"
    "ActionPosition\0LeadingPosition\0"
    "TrailingPosition\0Normal\0NoEcho\0Password\0"
    "PasswordEchoOnEdit"
};
...
static const uint qt_meta_data_QLineEdit[] = {
 ...
 // properties: name, type, flags
      ...
      25, QMetaType::QString, 0x00595103,
 ...
 // enum data: key, value
      47, uint(QLineEdit::LeadingPosition),
      48, uint(QLineEdit::TrailingPosition),
      49, uint(QLineEdit::Normal),
      50, uint(QLineEdit::NoEcho),
      51, uint(QLineEdit::Password),
      52, uint(QLineEdit::PasswordEchoOnEdit),
...
void QLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLineEdit::textChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (QLineEdit::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLineEdit::textEdited)) {
                *result = 1;
            }
        }
        {
            typedef void (QLineEdit::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLineEdit::cursorPositionChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (QLineEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLineEdit::returnPressed)) {
                *result = 3;
            }
        }
        {
            typedef void (QLineEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLineEdit::editingFinished)) {
                *result = 4;
            }
        }
        {
            typedef void (QLineEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QLineEdit::selectionChanged)) {
                *result = 5;
            }
        }
    }
...
const QMetaObject QLineEdit::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QLineEdit.data,
      qt_meta_data_QLineEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
